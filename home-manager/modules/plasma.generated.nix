{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Walk Through Windows (Reverse)" = "Alt+Shift+Backtab,Alt+Shift+Tab,Naviguer parmi les fenêtres (en ordre inverse)";
    ...
    configFile = {
      ...
      "katerc"."lspclient"."AllowedServerCommandLines" = "/home/solarliner/.nix-profile/bin/rust-analyzer";
      ...
      "kdeglobals"."General"."AccentColor" = "99,121,187";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/var/mnt/Nathan 1TB/Photos/Wallpapers/wallhaven-ymreod.jpg";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/var/mnt/Nathan 1TB/Photos/Wallpapers/wallhaven-ymreod.jpg";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" = "/run/media/solarliner/Nathan 1TB/Photos/Wallpapers/wallhaven-wqw3j6.jpg,/run/media/solarliner/Nathan 1TB/Photos/Wallpapers/wallhaven-zmjy7v.jpg";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/solarliner/.config/environment.d/10-home-manager.conf";
