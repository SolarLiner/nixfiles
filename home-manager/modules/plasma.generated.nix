{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "lattedock"."clear-history" = [];
      "lattedock"."clipboard_action" = [];
      "lattedock"."cycleNextAction" = [];
      "lattedock"."cyclePrevAction" = [];
      "lattedock"."edit_clipboard" = [];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."7d1fa105-2f48-4354-bdad-d819583e50c3" = "Défaut";
      "kactivitymanagerdrc"."main"."currentActivity" = "7d1fa105-2f48-4354-bdad-d819583e50c3";
      ...
      "kdeglobals"."WM"."activeBackground" = "54,54,54";
      "kdeglobals"."WM"."activeBlend" = "252,252,252";
      "kdeglobals"."WM"."activeFont" = "Inter,11,-1,5,50,0,0,0,0,0";
      "kdeglobals"."WM"."activeForeground" = "252,252,252";
      "kdeglobals"."WM"."inactiveBackground" = "42,46,50";
      "kdeglobals"."WM"."inactiveBlend" = "115,115,115";
      "kdeglobals"."WM"."inactiveForeground" = "115,115,115";
      "kglobalshortcutsrc"."ActivityManager"."_k_friendly_name" = "Gestion des activités";
      "kglobalshortcutsrc"."KDE Keyboard Layout Switcher"."_k_friendly_name" = "Commutateur de dispositions de clavier";
      "kglobalshortcutsrc"."kaccess"."_k_friendly_name" = "Accessibilité";
      "kglobalshortcutsrc"."kcm_touchpad"."_k_friendly_name" = "Pavé tactile";
      ...
      "kglobalshortcutsrc"."kmix"."_k_friendly_name" = "Volume audio";
      "kglobalshortcutsrc"."ksmserver"."_k_friendly_name" = "Gestion des sessions";
      "kglobalshortcutsrc"."kwin"."_k_friendly_name" = "KWin";
      "kglobalshortcutsrc"."lattedock"."_k_friendly_name" = "Latte Dock";
      "kglobalshortcutsrc"."mediacontrol"."_k_friendly_name" = "Contrôleur de média";
      ...
      "khotkeysrc"."Toolbar style"."ToolButtonStyle[$d]" = "";
