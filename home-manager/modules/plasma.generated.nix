{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Walk Through Windows" = ["Meta+Tab" ",Meta+Tab" "Alt+Tab,Naviguer parmi les fenêtres"];
      "kwin"."Walk Through Windows (Reverse)" = ["Meta+Shift+Tab" ",Meta+Shift+Tab" "Alt+Shift+Tab,Naviguer parmi les fenêtres (en ordre inverse)"];
      "kwin"."Walk Through Windows Alternative" = ["Alt+Tab" ",none,Naviguer parmi les alternatives de fenêtres"];
      "kwin"."Walk Through Windows Alternative (Reverse)" = ["Alt+Shift+Tab" ",none,Naviguer parmi les alternatives de fenêtres (en ordre inverse)"];
      "kwin"."Walk Through Windows of Current Application" = ["Meta+²" ",Meta+`" "Alt+`,Naviguer parmi les fenêtres de l'application courante"];
      "kwin"."Walk Through Windows of Current Application (Reverse)" = ["Meta+~" ",Meta+~" "Alt+~,Naviguer parmi les fenêtres de l'application courante (en ordre inverse)"];
      "kwin"."Walk Through Windows of Current Application Alternative" = ["Alt+²" ",none,Naviguer parmi les fenêtres de l'application alternative courante"];
      "kwin"."Walk Through Windows of Current Application Alternative (Reverse)" = ["Alt+~" ",none,Naviguer parmi les fenêtres de l'application alternative courante (en ordre inverse)"];
    ...
    configFile = {
      ...
      "kservicemenurc"."Show"."addToSteam" = true;
